        ...
        <div class="white-box">
            <table id="allUsers" class="display responsive nowrap" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th class="text-center">{{__('dashboard.visaNumber')}}</th>
                ...
                @foreach($users as $user)
                    @if($user->id!=auth()->id())
                        <tr>
                            ...
                            <td class="text-center">{{$user->visaNumber}}</td>
                            <td class="text-center">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input name="visaNumber" type="text" class="form-control"
                                                           value="{{$user->visaNumber}}"

                                                           placeholder="{{__('dashboard.visaNumber')}}">
                                                </div>
                            ...
                            <td class="text-center">
                                @if(($user->hasRole('admin') && auth()->user()->hasRole('admin') )|| !$user->hasRole('admin'))
                                    @if($user->active)
                                        <button type="button"
